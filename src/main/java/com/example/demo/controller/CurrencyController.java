...
public class CurrencyController {
    ...
    @PostMapping
    ResponseEntity<CurrencyResponse> save(@RequestBody CurrencyRequest currencyRequest){
        Currency savedCurrency= currencyService.addCurrency(convertor.convertToCurrency(currencyRequest));
        return ResponseEntity.status(HttpStatus.CREATED).body(convertor.toCurrencyResponse(savedCurrency));
    }
